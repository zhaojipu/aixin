...
import com.haoniu.aixin.base.EaseUI.EaseSettingsProvider;
...
public class EaseNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        if (message.getStringAttribute(Constant.MSGTYPE, "").equals(Constant.RABEND) || message.getStringAttribute(Constant.MSGTYPE, "").equals(Constant.RAB) || "系统管理员".equals(username)) {
            return;
        }
        try {
            ...
            switch (message.getStringAttribute(Constant.MSGTYPE, "")) {
                case Constant.ADDROOM:
                    notifyText += "创建房间成功，赶快邀请好友一起抢红包吧";
                    break;
                case Constant.ADDUSER:
                    notifyText += message.getStringAttribute(Constant.NAME, "") + "加入了房间";
                    break;
                ...
                case Constant.DELUSER:
                    notifyText += message.getStringAttribute(Constant.NAME, "") + "退出了房间";
                    break;
                case Constant.SHOTUSER:
                    notifyText += message.getStringAttribute(Constant.NAME, "") + "被房主踢出了房间";
                    break;
                case Constant.REDPACKET:
                    notifyText += message.getStringAttribute(Constant.NICKNAME, "") + "发了一个红包";
                    break;
            }
