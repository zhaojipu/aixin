...
import com.haoniu.aixin.widget.emojicon.EaseEmojiconMenu;
import com.haoniu.aixin.widget.emojicon.EaseEmojiconMenuBase;
import com.haoniu.aixin.widget.emojicon.EaseEmojiconMenuBase.EaseEmojiconMenuListener;
...
public class EaseChatInputMenu extends LinearLayout {
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (emojiconMenu == null) {
            ...
            if (emojiconGroupList == null) {
                ...
                emojiconGroupList.add(new EaseEmojiconGroupEntity(R.mipmap.f024, Arrays.asList(EaseDefaultEmojiconDatas.getData())));
            }
    ...
    public void registerMenuItemNumber(String name, int number, int itemId,
                                       EaseChatExtendMenu.EaseChatExtendMenuItemClickListener listener) {
        chatExtendMenu.registerMenuItemNumber(name, number, itemId, listener);
    }
