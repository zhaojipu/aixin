...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (msg != null) {
            GlideUtils.loadImageViewLoding(AppConfig.checkimg( EaseUserUtils.getUserInfo(msg.getFrom()).getAvatar()), holder.avator, R.mipmap.img_default_avatar);
            holder.agreeBtn.setVisibility(View.GONE);
            holder.refuseBtn.setVisibility(View.GONE);
            holder.message.setText(msg.getReason());
            holder.name.setText(EaseUserUtils.getUserInfo(msg.getFrom()).getNickname());
