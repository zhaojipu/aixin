...
import com.haoniu.aixin.widget.EaseConversationList.EaseConversationListHelper;
...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            GlideUtils.loadImageViewLoding(AppConfig.checkimg( MyHelper.getInstance().getGroupById(groupId).getHead()), holder.avatar, R.mipmap.ic_launcher);
            holder.name.setText(group != null ? group.getGroupName() : username);
        } else {
            if (username.equals(Constant.ADMIN)) {
                holder.name.setText(getContext().getResources().getString(R.string.xttz));
                GlideUtils.loadImageView(R.mipmap.ic_launcher, holder.avatar);
            } else {
        ...
        if (holder.avatar instanceof EaseImageView) {
            MyApplication.getInstance().setAvatar((EaseImageView) holder.avatar);
        }
