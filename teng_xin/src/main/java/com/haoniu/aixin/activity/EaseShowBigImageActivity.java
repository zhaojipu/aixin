...
import com.haoniu.aixin.model.EaseImageCache;
import com.haoniu.aixin.utils.EaseLoadLocalBigImgTask;
import com.haoniu.aixin.widget.photoview.EasePhotoView;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.mipmap.img_default_avatar);
