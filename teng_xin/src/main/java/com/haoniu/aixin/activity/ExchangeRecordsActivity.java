...
import com.haoniu.aixin.adapter.ExchangeRecordsAdapter;
...
public class ExchangeRecordsActivity extends BaseActivity {
    ...
    protected void initLogic() {
        ...
        mRecordsAdapter = new ExchangeRecordsAdapter(mWaterInfos);
    ...
    private void getData() {
        ...
        map.put("pages", page);
        ApiClient.requestNetHandleByGet(this, AppConfig.exchangeCrediRecords, "", map, new ResultListener() {
            /**
             * 请求成功
             *
             * @param json
            ...
            public void onSuccess(String json, String msg) {
                if (json != null) {
                    XLog.json(json);
                    List<CreditRecordsInfo> list = FastJsonUtil.getList(json, CreditRecordsInfo.class);
